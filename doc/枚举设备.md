<div align="right"> 2023年4月6日 </div>

---

根据 [如何枚举windows系统中的所有设备](https://blog.csdn.net/fjb2080/article/details/5488131) 文章所述, 可用以下 API 枚举 Windows 下的设备:
...
[命名文件、路径和命名空间](https://learn.microsoft.com/zh-cn/windows/win32/fileio/naming-a-file)
